			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="step-item">
						...
						<form action="step-2-v2.php" class="validate-model-on-submit form-simple form-md wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
						...
						<div class="img-wr alignright box-shadow">
							...
							<div class="display-inline-block">
								<div class="tooltip-item">
									<div class="tooltip-item-inner bg-white color-theme">-$954</div>
								</div>
