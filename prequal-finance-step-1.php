			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="dots-nav">
						...
						<a href="prequal-finance-step-1.php" class="bg-brick">4</a>
					</div>
					<div class="step-item">
						<h1 class="color-theme">What is the monthly car payment you are comfortable with?</h1>
						<form action="prequal-finance-step-2.php" class="form-simple form-small wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
									<div class="input-item text-center">
										<input data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0'" inputmode="numeric" type="text" required placeholder="Monthly car payment target">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="input-item text-center">
