		...
		<div class="content bg-gradient-blue" id="content">
			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="step-item">
						<h1 class="color-theme">How about mileage. Do you want a car that has a maximum amount of miles?</h1>
						<form action="step-6-v2.php" class="form-simple form-small wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
