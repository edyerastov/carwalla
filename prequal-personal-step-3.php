		...
		<div class="content bg-gradient-blue" id="content">
			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="step-item">
						<h1 class="color-theme">Please enter your phone number below.</h1>
						<form action="prequal-personal-step-4.php" class="form-simple form-small wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
									<div class="input-item text-center">
										<input data-inputmask="'mask': '(999) 999-9999'" type="text" required placeholder="Phone number">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="input-item text-center">
