		...
		<div class="content bg-gradient-blue" id="content">
			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="dots-nav">
						<a href="step-1.php" class="bg-brick">1</a>
						<a href="step-3.php" class="bg-theme">2</a>
						<a href="step-4.php" class="bg-theme">3</a>
					</div>
					<div class="step-item">
						<h1 class="color-theme">Great choice. Carwalla customers have recently seen Honda Civic price drops of $532!</h1>
						<form action="step-3.php" class="form-simple form-md wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
									<br>
								</div>
