		...
		<div class="content bg-gradient-blue" id="content">
			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="step-item">
						<h1 class="color-theme">Awesome Shaun. Please enter your email address below.</h1>
						<form action="prequal-personal-step-3.php" class="form-simple form-small wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
