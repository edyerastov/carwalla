		...
		<div class="content bg-gradient-blue" id="content">
			...
			<div class="box-wr box-step text-center">
				<div class="container wow fadeIn" data-wow-delay="0.2s">
					...
					<div class="step-item">
						<h1 class="color-theme">What is the most money you can put down for a car deposit?</h1>
						<form action="step-success.php" class="form-simple form-small wow fadeInUp" data-wow-delay="0.4s">
							<div class="row">
								<div class="col-sm-12">
									<div class="input-item text-center">
										<input data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0'" inputmode="numeric" type="text" required placeholder="Car deposit">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="input-item text-center">
